        ...
        <div className="w-full navbar-end">
          <div className="w-full flex justify-between">
            ...
            <div className="dropdown">
              <label tabIndex={0} className="btn btn-ghost lg:hidden relative">
                <svg
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box absolute top-14 right-0 w-52"
              >
                <li>
                  <a>Item 1</a>
                </li>
